...
(**[init_state_fold] creates an initial state that is used when evaluating the state in post-preflop rounds*)
...
(**[find_winner] evaluates the two player hands and river to determine who the winner is*)
