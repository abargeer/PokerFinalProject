...
let check_4kind cards =
  let numOfKind = Array.make 13 0 in
  let sortedCards = List.sort compareCards cards in
  match sortedCards with
  | [ a; b; c; d; e ] ->
...
let hand_value hand =
  let value = ref 1 in
  if check_pair hand then value := 2
  else if check_2pair hand then value := 3
  else if check_3kind hand then value := 4
  else if check_straight hand then value := 5
  else if check_flush hand then value := 6
  else if check_full_house hand then value := 7
  else if check_4kind hand then value := 8
  else if check_straight_flush hand then value := 9;
  !value
